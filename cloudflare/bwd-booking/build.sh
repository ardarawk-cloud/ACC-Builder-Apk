...
grep -q 'I HAVE PAID · SEND PROOF' "$PUBLIC/index.html"
grep -q 'UPLOAD SCREENSHOT / FILE' "$PUBLIC/index.html"
grep -q 'TAKE PHOTO' "$PUBLIC/index.html"
grep -q 'payment-option' "$PUBLIC/index.html"
grep -q '>WHATSAPP</a>' "$PUBLIC/index.html"
